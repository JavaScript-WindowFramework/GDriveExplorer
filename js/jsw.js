    ...
    */
    var ListView = /** @class */ (function (_super) {
        ...
        ListView.prototype.getSelectItem = function () {
            var e_1, _a;
            try {
                for (var _b = __values(this.selectIndexes), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var index = _c.value;
                    return index;
                }
            }
            ...
            for (var i = 0, length_11 = columns.length; i < length_11; i++) {
                ...
                cell.addEventListener('click', function (e) {
                    ...
                    if (e.ctrlKey) {
                        ...
                        var e_6 = Math.max(that.lastIndex, index);
                        for (var i_3 = s; i_3 <= e_6; i_3++)
                            indexes.push(i_3);
